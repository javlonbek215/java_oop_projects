...
public class TaxiCompany {
    ...
    public ArrayList<Info1> statsTaxi() {

        ArrayList<Info1> taxiList = new ArrayList<>(this.allTaxiMap.values());
        Collections.sort(taxiList);

        return taxiList;
    }

    public ArrayList<Info1> statsDistricts() {

        ArrayList<Info1> list = new ArrayList<>(this.districtByTripCountMap.values());
